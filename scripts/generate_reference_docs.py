    ...
    lines = [
        ...
        _html_table(
            ...
            [
                ...
                [_code("COMPOSITE_TASK"), "최소 1개 이상의 child task call을 직접 포함하는 workflow입니다. orchestration용 primitive step을 함께 가질 수 있습니다.", f"{_code('REPLENISH_MATERIAL')} -> {_code('TRANSFER')}, {_code('SETUP_MACHINE')} -> {_code('LOAD_MACHINE')}"],
            ],
            ["16%", "56%", "28%"],
        ),
        "",
